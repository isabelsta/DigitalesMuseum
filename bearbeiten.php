                    ...
                    <form accept-charset="UTF-8" role="form" action="personBearbeitet.php?PID=<?=$PID?>" method="post" enctype='multipart/form-data'>
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Vorname" class="form-control form-control-custom" name="vorname" value="<?=$row['vorname']?>">
                            </div>
                            <div class="form-group">
                                <label for="nachname">Nachname:</label>
                                <input type="text" placeholder="Nachname" class="form-control form-control-custom" name="nachname" value="<?=$row['name']?>">
                            </div>
                            <div class="form-group">
                                <label for="gebDat">Geburtsdatum:</label>
                                <input type="text" placeholder="yyyy-mm-dd" class="form-control form-control-custom" name="gebDat" value="<?=$row['geb']?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="0-150" class="form-control form-control-custom" name="alter" value="<?=$row['age']?>">
                            </div>
                            <div class="form-group">
